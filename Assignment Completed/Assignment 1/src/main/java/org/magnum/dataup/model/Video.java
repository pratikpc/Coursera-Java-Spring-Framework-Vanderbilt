...
public class Video {
    ...
    public interface VideoBuilder extends Builder<Video> {
        VideoBuilder withTitle(String title);

        VideoBuilder withDuration(long duration);

        VideoBuilder withSubject(String subject);

        VideoBuilder withContentType(String contentType);
    }
